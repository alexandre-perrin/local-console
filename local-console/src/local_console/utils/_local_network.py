...
def _get_network_ifaces() -> list[str]:
    """
...
LOCAL_IP: str = _get_my_ip_by_routing()


def _replace_local_address(hostname: str) -> str:
    return LOCAL_IP if _is_localhost(hostname) else hostname
